...
In my postdoctoral fellowship period with [Richard Murray](https://murray.cds.caltech.edu/Main_Page) and [William Clemons](https://clemonslab.caltech.edu/) at Caltech, I went after mechanistic insight into cell-free systems and phage biology. Together, these experiences shaped how I think about and approach cell-free synthetic biology: learn the machines, build the platform, and ship the program so it works on deployment.
